...
def main():
    ...
    parser.add_argument('--script', type=str, default='cdaatrack', help='name of the train script')
    parser.add_argument('--config', type=str, default='cdaatrack', help='name of the config file(baseline, cdaatrack)')
    ...
    parser.add_argument('--save_dir', type=str,
                        default='/vol/research/facer2vm_tracking/people/xuefeng/CDAAT/lib/train',
