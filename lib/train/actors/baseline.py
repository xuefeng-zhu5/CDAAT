...
class BASELINEActor(BaseActor):
    ...
    def forward_pass(self, data):
        ...
        out_embed, _, _, _ = self.net(search_dic=search_dict, refer_dic_list=feat_dict_list[0],
                                      refer_reg_list=refer_reg_list[0], mode='transformer')

        # Forward the corner head
        out_dict, _ = self.net(out_embed=out_embed, mode='head')  # out_dict: (B, N, C), outputs_coord: (1, B, N, C)
