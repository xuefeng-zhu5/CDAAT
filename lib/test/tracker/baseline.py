...
from lib.models.cdaatrack import build_baseline
...
class BASELINETRACK(BaseTracker):
    def __init__(self, params, dataset_name):
        super(BASELINETRACK, self).__init__(params)
        network = build_baseline(params.cfg)
