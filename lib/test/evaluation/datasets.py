...
dataset_dict = dict(
    ...
    depthtrack=DatasetInfo(module=pt % "depthtrack", class_name="DepthTrackDataset", kwargs=dict(dtype='rgbrawd')),
    rgbd1k=DatasetInfo(module=pt % "rgbd1k", class_name="RGBD1KDataset", kwargs=dict(dtype='rgbrawd')),
    cdtb=DatasetInfo(module=pt % "cdtb", class_name="CDTBDataset", kwargs=dict(dtype='rgbrawd'))
)
