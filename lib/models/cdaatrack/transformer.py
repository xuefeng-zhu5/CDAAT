...
from lib.models.cdaatrack.attention import AiAModule
...
class Transformer(nn.Module):
    ...
    def run_decoder(self, search_mem, refer_mem, refer_emb, refer_pos, refer_msk):
        """
        Args:
            search_mem: (HW, bs, C)
            pos_emb: (HW, bs, C)
        ...
        return self.decoder(search_mem, refer_mem, refer_emb, refer_pos, refer_msk)
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt, refer_mem, refer_emb, refer_pos, refer_msk):
        # Mutual attention
        mem_ensemble = refer_mem
        emb_ensemble = refer_emb
        # refer_pos = refer_pos
        # refer_msk = refer_msk
        refer_queries = tgt
        ...
        tgt = tgt + self.dropout1_1(long_tgt_refer)
        tgt = self.norm1(tgt)
        # FFN
