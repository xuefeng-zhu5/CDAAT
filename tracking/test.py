...
def main():
    ...
    parser.add_argument('--tracker', type=str, default='cdaatrack', help='name of tracking method')
    parser.add_argument('--param', type=str, default='cdaatrack', help='name of config file')
    parser.add_argument('--id', type=int, default=None, help='the run ID')
    parser.add_argument('--dataset', type=str, default='rgbd1k',
                        help='name of dataset (otb, nfs, uav, trackingnet, got10k_test, got_val, lasot, lasot_ext)')
